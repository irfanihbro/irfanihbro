...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=700&color=2EF7A1&center=true&vCenter=true&width=600&lines=INTJ;Computer+Science+Student;Tech+Enthusiast;Linux+Enthusiast;Automotive+Enthusiast;Music+%7C+Movies+%7C+Books;Art+Lover;Hobbyist+Photographer;Amateur+Guitarist;Casual+Gamer;Always+Learning+Something+New)](https://git.io/typing-svg)
...
- **OS:** Linux (Arch, OpenWrt, Kali & Proxmox/Debian), Windows, Android, MikroTik RouterOS & Cisco IOS
...
Development:
  Editor:
    desktop: ["Neovim", "VS Code", "Acode", "Arduino IDE"]
    mobile: ["Acode"]
    terminal: ["Kitty", "PowerShell", "Termux"]
